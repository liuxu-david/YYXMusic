...
__DEFINE__(1652170881494, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1652170881495,"./event-store":1652170881496}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652170881495, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1652170881496, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1652170881495,"./utils":1652170881497}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652170881497, function(require, module, exports) {
...
return __REQUIRE__(1652170881494);
})()
